		...
		<div class="slides">
			<div class="slide">
				...
				<div class="slide-text">
					<h2  style="color: white;">Sydney Festival</h2>
			...
			<div class="slide">
				...
				<div class="slide-text">
					<h2  style="color: white;">Melbourne Cup</h2>
			...
			<div class="slide">
				...
				<div class="slide-text">
					<h2  style="color: white;">Vivid Sydney</h2>
			...
			<div class="slide">
				...
				<div class="slide-text">
					<h2  style="color: white;">Woodford Folk Festival</h2>
			...
			<div class="slide">
				...
				<div class="slide-text">
					<h2  style="color: white;">Dark Mofo</h2>
